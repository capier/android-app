...
interface MessageDao : BaseDao<Message> {
    ...
    @Query("SELECT m.id as messageId, m.conversation_id as conversationId, u.user_id as userId, " +
        ...
        "m.name as mediaName, m.media_mine_type as mediaMineType, m.media_size as mediaSize, m.media_width as mediaWidth, m.media_height as mediaHeight, " +
    ...
    @Query("UPDATE messages SET content = :content, media_mine_type = :mediaMineType, " +
